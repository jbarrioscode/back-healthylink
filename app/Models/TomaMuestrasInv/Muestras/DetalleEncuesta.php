...
class DetalleEncuesta extends Model
{
    ...
    protected $fillable = [
        ...
        'pais_nacimiento',
        'ciudad_nacimiento',
        'nacionalidad_pais_abuelo_materno',
        'nacionalidad_ciudad_abuelo_materno',
        'nacionalidad_pais_abuela_materno',
        'nacionalidad_ciudad_abuela_materno',
        'nacionalidad_pais_abuelo_paterno',
        'nacionalidad_ciudad_abuelo_paterno',
        'nacionalidad_pais_abuela_paterno',
        'nacionalidad_ciudad_abuela_paterno',
        'es_fumador',
        'presion_arterial',
