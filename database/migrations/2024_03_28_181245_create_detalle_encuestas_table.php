...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('minv_detalle_encuestas', function (Blueprint $table) {
            ...
            $table->string('nacionalidad_pais_abuelo_materno')->nullable();
            $table->string('nacionalidad_ciudad_abuelo_materno')->nullable();
            $table->string('nacionalidad_pais_abuela_materno')->nullable();
            $table->string('nacionalidad_ciudad_abuela_materno')->nullable();
            $table->string('nacionalidad_abuelo_paterno')->nullable();
            $table->string('nacionalidad_pais_abuelo_paterno')->nullable();
            $table->string('nacionalidad_ciudad_abuelo_paterno')->nullable();
            $table->string('nacionalidad_pais_abuela_paterno')->nullable();
            $table->string('nacionalidad_ciudad_abuela_paterno')->nullable();
